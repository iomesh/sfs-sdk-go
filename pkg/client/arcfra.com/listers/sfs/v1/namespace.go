...
// List lists all Namespaces in the indexer for a given namespace.
func (s namespaceNamespaceLister) List(selector labels.Selector) (ret []*v1.Namespace, err error) {
...
// Get retrieves the Namespace from the indexer for a given namespace and name.
func (s namespaceNamespaceLister) Get(name string) (*v1.Namespace, error) {
