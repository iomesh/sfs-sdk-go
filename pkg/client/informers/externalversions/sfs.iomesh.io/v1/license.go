	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SfsV1().Licenses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SfsV1().Licenses(namespace).Watch(context.TODO(), options)
			},
		},
		&sfsiomeshiov1.License{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *licenseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sfsiomeshiov1.License{}, f.defaultInformer)
}
