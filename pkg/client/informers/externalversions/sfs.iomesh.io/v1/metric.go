	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SfsV1().Metrics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SfsV1().Metrics(namespace).Watch(context.TODO(), options)
			},
		},
		&sfsiomeshiov1.Metric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *metricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sfsiomeshiov1.Metric{}, f.defaultInformer)
}

func (f *metricInformer) Lister() v1.MetricLister {
	return v1.NewMetricLister(f.Informer().GetIndexer())
}
