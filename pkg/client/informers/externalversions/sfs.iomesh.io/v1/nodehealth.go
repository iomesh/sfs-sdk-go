	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SfsV1().NodeHealths(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SfsV1().NodeHealths(namespace).Watch(context.TODO(), options)
			},
		},
		&sfsiomeshiov1.NodeHealth{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeHealthInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sfsiomeshiov1.NodeHealth{}, f.defaultInformer)
}

func (f *nodeHealthInformer) Lister() v1.NodeHealthLister {
	return v1.NewNodeHealthLister(f.Informer().GetIndexer())
}
