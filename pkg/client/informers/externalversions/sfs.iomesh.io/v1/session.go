	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SfsV1().Sessions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SfsV1().Sessions(namespace).Watch(context.TODO(), options)
			},
		},
		&sfsiomeshiov1.Session{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sessionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sfsiomeshiov1.Session{}, f.defaultInformer)
}
